                        ...
                        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                                  <div style={{ padding: '24px 24px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
                                              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                                            ...
                                                            <div style={{ fontFamily: 'var(--font-display)', fontSize: 22, lineHeight: 1, color: '#fff' }}>Discovery</div>div>
                                              </div>div>
                                                                                                                ...
                                                                                                                return (
                                                                                                                                    <article
                                                                                                                                      ...
                                                                                                                                      {question.type === 'scale' && (
                                                                                                                                                                                <>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, fontSize: 11, color: 'var(--text-3)', maxWidth: 250 }}>
                                                                                                                                                                                                                                  <span>{question.scaleMinLabel || 'Lågt'}</span>span>
                                                                                                                                                                                                                                  <span>{question.scaleMaxLabel || 'Högt'}</span>span>
                                                                                                                                                                                                                                </div>div>
                                                                                                                                                                                  </>>
                                                                                                                                                                              )}
                                                                                                                                      ...
                                                                                                                                      {question.type === 'likert' && (() => {
                                                                                                                                                                                const agreementValue = answers[question.id + '_agreement']
                                                                                                                                                                                                        const importanceValue = answers[question.id + '_importance']
                                                                                                                                                                                                                                const hasAgreement = typeof agreementValue === 'string' && agreementValue !== ''
                                                                                                                                                                                                                                  
                                                                                                                                                                                                                                                        return (
                                                                                                                                                                                                                                                                                  <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                                                                                                                                                                                                                                                                                                            {/* Agreement axis */}
                                                                                                                                                                                                                                                                                                            <div>
                                                                                                                                                                                                                                                                                                                                        <div style={{ fontSize: 13, color: 'var(--text-3)', marginBottom: 10 }}>Enighet</div>div>
                                                                                                                                                                                                                                                                                                                                        <div style={{ display: 'flex', gap: 8, marginBottom: 6, flexWrap: 'wrap' }}>
                                                                                                                                                                                                                                                                                                                                                                      {[1, 2, 3, 4, 5].map(n => {
                                                                                                                                                                                                                                                                                                                    const sel = agreementValue === String(n)
                                                                                                                                                                                                                                                                                                                                                      return (
                                                                                                                                                                                                                                                                                                                                                                                          <button
                                                                                                                                                                                                                                                                                                                                                                                                                                key={n}
                                                                                                                                                                                                                                                                                                                                                                                                                                type="button"
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-3)', maxWidth: 310 }}>
                                                                                                                                                                                                                                                                                                                                                                      <span>Håller inte alls</span>span>
                                                                                                                                                                                                                                                                                                                                                                      <span>Håller helt</span>span>
                                                                                                                                                                                                                                                                                                                                                                    </div>div>
                                                                                                                                                                                                                                                                                                                                      </div>div>
                                                                                                                                                                                                                                                                                  
                                                                                                                                                                                                                                                                                                            {/* Importance axis – only shown after agreement is answered */}
                                                                                                                                                                                                                                                                                                            {hasAgreement && (
                                                                                                                                                                                                                                                                                                                <div style={{
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              <div style={{ fontSize: 15.5, fontWeight: 600, lineHeight: 1.58, color: 'var(--text)', marginBottom: 10, maxWidth: 720 }}>
                                                                                                                                                                                                                                                                                                                                                                              {question.text}
                                                                                                                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                                                                                                                              <div style={{ fontSize: 13, color: 'var(--text-3)', marginBottom: 10 }}>Hur viktigt är detta?</div>div>
                                                                                                                                                                                                                                                                                                                                              <div style={{ display: 'flex', gap: 8, marginBottom: 6, flexWrap: 'wrap' }}>
                                                                                                                                                                                                                                                                                                                                                                              {[1, 2, 3, 4, 5].map(n => {
                                                                                                                                                                                                                                                                                                                                                    const sel = importanceValue === String(n)
                                                                                                                                                                                                                                                                                                                                                                                        return (
                                                                                                                                                                                                                                                                                                                                                                                                                              <button
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      key={n}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      type="button"
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-3)', maxWidth: 310 }}>
                                                                                                                                                                                                                                                                                                                                                                              <span>Inte viktigt</span>span>
                                                                                                                                                                                                                                                                                                                                                                              <span>Mycket viktigt</span>span>
                                                                                                                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                                                                                                                            </div>div>
                                                                                                                                                                                                                                                                                                            )}
                                                                                                                                                                                                                                                                                                          </div>div>
    ...
    return (
          <div style={{ width: '100%', maxWidth: 620, background: 'var(--surface)', borderRadius: 20, overflow: 'hidden', border: '1px solid var(--border)', boxShadow: '0 24px 64px rgba(0,0,0,0.06)' }}>
                <div style={{ background: 'var(--text)', padding: '28px 28px 24px' }}>
                        ...
                        <div style={{ fontFamily: 'var(--font-display)', fontSize: 30, fontWeight: 700, color: '#fff', lineHeight: 1.1 }}>{title}</div>div>
                        <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.78)', marginTop: 10, lineHeight: 1.65 }}>{description}</div>div>
                </div>div>
            {children && (
