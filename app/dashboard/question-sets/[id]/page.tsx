  ...
  return (
    <div style={{ padding: '36px 40px', maxWidth: 680, fontFamily: 'DM Sans, sans-serif' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24, fontSize: 13 }}>
        ...
        <span style={{ color: '#111', fontWeight: 500 }}>Redigera</span>
      </div>

      <h1 style={{ fontSize: 22, fontWeight: 600, color: '#111', margin: '0 0 28px' }}>Redigera frågebatteri</h1>
      ...
      <form onSubmit={save} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <Section>
          <div style={{ fontSize: 12, fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 2 }}>
          ...
          <button type="button" onClick={addQuestion}
                  style={{ marginTop: 8, background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, color: '#C62368', fontWeight: 500, padding: 0, display: 'flex', alignItems: 'center', gap: 5, fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <div style={{ display: 'flex', gap: 10, paddingTop: 4 }}>
          ...
          <button type="submit" disabled={saving} style={{
            ...
            background: saved ? '#16a34a' : saving ? '#e08aaa' : '#C62368',
            border: 'none', fontSize: 13.5, fontWeight: 500, color: '#fff',
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div>
      <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 7 }}>
        {label}
      </label>
      {children}
    </div>
